	...
	if(empty($idhorario)) {
		?>
		<form action="../../Negocios/Horario/Insertar.php" method="POST">
			<label>Nombre</label><input type="text" name="nombre">
			<label>Hora Inicio</label><input type="text" name="hora_inicio">
			<label>Hora Fin</label><input type="text" name="hora_fin">
			<br>
		...
		$Horariotemp= new HorarioDao();
		$Horariotemp->ObtenerHorario($idhorario);
		for ($i=0; $i < count($Horariotemp->idhorario);$i++) { 

			$nombretemp=$Horariotemp->nombre[$i];
			$hora_inicio=$Horariotemp->hora_inicio[$i];
			$hora_fin=$Horariotemp->hora_fin[$i];
		}
		?>
		<form action="../../Negocios/Horario/Actualizar.php" method="post">
  	...
  	<label>Hora Inico:</label><input type="text" name="hora_inicio" value="<?php echo $hora_inicio;?>">
  	<label>Hora Fin:</label><input type="text" name="hora_fin" value="<?php echo $hora_fin;?>">
  	<br>
