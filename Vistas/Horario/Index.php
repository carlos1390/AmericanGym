	...
	<div class="span12 well">
	    ...
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarHorario.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($horario->idhorario) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $horario->idhorario[$i]; ?></td>
                <td> <?php echo $horario->nombre[$i]; ?></td>
                <td> <?php echo $horario->hora_inicio[$i]; ?></td>
                <td> <?php echo $horario->hora_fin[$i]; ?></td>
                <td><a href='GestionarHorario.php?idhorario=<?php echo $horario->idhorario[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Horario/Eliminar.php?id=<?php echo $horario->idhorario[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
