 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Unidades de Medida</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarUnidadMedida.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
			...
			$unidaddemedida->ObtenerUnidaddeMedidas();
	        for ($i=0; $i <count($unidaddemedida->idunidademedida) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $unidaddemedida->idunidademedida[$i]; ?></td>
                <td> <?php echo $unidaddemedida->nombre[$i]; ?></td>
                <td><a href='GestionarUnidadMedida.php?idunidaddemedida=<?php echo $unidaddemedida->idunidademedida[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/UnidadMedida/Eliminar.php?id=<?php echo $unidaddemedida->idunidademedida[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
