 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Genero</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarGenero.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($genero->idgenero) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $genero->idgenero[$i]; ?></td>
                <td> <?php echo $genero->nombre[$i]; ?></td>
                <td><a href='GestionarGenero.php?idgenero=<?php echo $genero->idgenero[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Genero/Eliminar.php?id=<?php echo $genero->idgenero[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
