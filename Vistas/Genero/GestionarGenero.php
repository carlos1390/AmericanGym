...
<?php
	...
	if(empty($idgenero)) {
		?>
		<form action="../../Negocios/Genero/Insertar.php" method="POST">
		...
		$Generotemp= new GeneroDao();
		$Generotemp->ObtenerGenero($idgenero);
		for ($i=0; $i < count($Generotemp->idgenero);$i++) { 

			$nomretemp=$Generotemp->nombre[$i];
		}
		?>
		<form action="../../Negocios/Genero/Actualizar.php" method="post">
		<input type="hidden" name="id" Value="<?php echo $idgenero;?>"> 
