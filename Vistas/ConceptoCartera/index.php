 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Conceptos de Cartera</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='gestionarConceptoCartera.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
            ...
            $conceptocartera->obteberConceptoCarteras();
	        for ($i=0; $i <count($conceptocartera->idconceptocartera) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $conceptocartera->idconceptocartera[$i]; ?></td>
                <td> <?php echo $conceptocartera->nombre[$i]; ?></td>
                <td> <?php echo "$ ".number_format($conceptocartera->totalconcepto[$i]); ?></td>
                <td><a href='gestionarConceptoCartera.php?idconceptocartera=<?php echo $conceptocartera->idconceptocartera[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/ConceptoCartera/eliminar.php?id=<?php echo $conceptocartera->idconceptocartera[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
