	...
	<div class="span12 well">
	    ...
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='gestionarEps.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($eps->ideps) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $eps->ideps[$i]; ?></td>
                <td> <?php echo $eps->nombre[$i]; ?></td>
                <td><a href='gestionareps.php?ideps=<?php echo $eps->ideps[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Eps/eliminar.php?id=<?php echo $eps->ideps[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
