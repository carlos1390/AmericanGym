	...
	<div class="span12 well">
	    ...
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='gestionarperfil.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($perfil->idperfil) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $perfil->idperfil[$i]; ?></td>
                <td> <?php echo $perfil->nombre[$i]; ?></td>
                <td> <?php echo $perfil->valor[$i]; ?></td>
                <td><a href='gestionarperfil.php?idperfil=<?php echo $perfil->idperfil[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Perfil/eliminar.php?id=<?php echo $perfil->idperfil[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
