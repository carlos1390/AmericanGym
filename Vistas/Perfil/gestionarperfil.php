    ...
    extract($_GET);
     if (empty($idperfil)){
     ?>
     <form action='../../Negocios/Perfil/insertar.php' method="POST" >
    ...
    else
  {
    ...
    $perfiltemp= new PerfilDAO(); 
    //echo $idpersona;
    $perfiltemp->obteberperfil($idperfil);
    for ($i = 0; $i < count($perfiltemp->idperfil); $i++)
     {
        $nombretemp=$perfiltemp->nombre[$i];
        $valortemp=$perfiltemp->valor[$i];
      }

    ?>
    <form action="../../Negocios/Perfil/actualizar.php" method="post">
    ...
    <br>
    <label>Valor:</label><input type="text" name="valor" value="<?php echo $valortemp;?>">
    <br>
