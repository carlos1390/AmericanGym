 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Tipos de Documento</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarTipoDocumento.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($TipoDocumento->idtipodocumento) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $TipoDocumento->idtipodocumento[$i]; ?></td>
                <td> <?php echo $TipoDocumento->nombre[$i]; ?></td>
                <td><a href='GestionarTipoDocumento.php?idTipoDocumento=<?php echo $TipoDocumento->idtipodocumento[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/TipoDocumento/Eliminar.php?id=<?php echo $TipoDocumento->idtipodocumento[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
