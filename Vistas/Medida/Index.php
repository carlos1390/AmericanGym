	...
	<div class="span12 well">
	    ...
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarMedida.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($MedidaTemp->id_medida) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $MedidaTemp->nombre_medida[$i]; ?></td>
                <td> <?php echo $MedidaTemp->nombre_unidad[$i]; ?></td>
                <td><a href='GestionarMedida.php?idmedida=<?php echo $MedidaTemp->id_medida[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Medida/Eliminar.php?idmedida=<?php echo $MedidaTemp->id_medida[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
