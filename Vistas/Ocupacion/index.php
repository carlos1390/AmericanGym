 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Ocupaciones</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='gestionarocupacion.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($ocupacion->idocupacion) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $ocupacion->idocupacion[$i]; ?></td>
                <td> <?php echo $ocupacion->nombre[$i]; ?></td>
                <td><a href='gestionarocupacion.php?idocupacion=<?php echo $ocupacion->idocupacion[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Ocupacion/eliminar.php?id=<?php echo $ocupacion->idocupacion[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
