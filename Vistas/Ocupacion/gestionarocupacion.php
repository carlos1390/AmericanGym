        ...
        <div class="row-fluid">
          ...
          <div class="span12 well">
            ...
            if (empty($idocupacion)){
             ?>
             <form action='../../Negocios/Ocupacion/insertar.php' method="POST" >
           ...
           else
           {
            ...
            $ocupaciontemp= new OcupacionDAO(); 
    //echo $idpersona;
            $ocupaciontemp->obteberocupacion($idocupacion);
            for ($i = 0; $i < count($ocupaciontemp->idocupacion); $i++)
            {
              $nombretemp=$ocupaciontemp->nombre[$i];

            }

            ?>
            <form action="../../Negocios/Ocupacion/actualizar.php" method="post">
              <input type="hidden" name="id" value="<?php echo $idocupacion;?> ">
