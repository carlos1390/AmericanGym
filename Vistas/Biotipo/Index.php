 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Biotipos</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarBiotipo.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($biotipo->idbiotipo) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $biotipo->idbiotipo[$i]; ?></td>
                <td> <?php echo $biotipo->nombre[$i]; ?></td>
                <td><a href='GestionarBiotipo.php?idbiotipo=<?php echo $biotipo->idbiotipo[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Biotipo/Eliminar.php?id=<?php echo $biotipo->idbiotipo[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
