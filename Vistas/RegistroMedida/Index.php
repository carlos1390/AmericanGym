 ...
 <div class="row-fluid">          
  ...
  <div class="span12 well">
    <div class="page-header">
      <h4>Gestionar Registro Medida</h4>
    </div>
      <form action="" class="form-inline">  
      <div class="input-append">
           <a href='GestionaRegistroMedida.php' class="btn">Crear Nuevo</a>
      </div>        
      </form>
    </div>
    <!--Tabla-->
    ...
    <table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
      ...
      <?php
          require_once '../../Datos/RegistroMedida/RegistroMedidaDao.php';
         $Registros_Medida= new RegistroMedidaDao();
         $Registros_Medida->ObtenerRegMedidas();
          for ($i=0; $i <count($Registros_Medida->Id_RegistroMedida) ; $i++) { 
            ?>
            <tr>
               <td> <?php echo $Registros_Medida->Fecha_medida[$i]; ?></td>
                <td> <?php echo $Registros_Medida->Nombres_persona[$i]; ?></td>
                <td> <?php echo $Registros_Medida->nombremedida[$i]; ?></td>
                <td> <?php echo $Registros_Medida->valor[$i]; ?></td>
                <td> <?php echo $Registros_Medida->Unidad_medida[$i]; ?></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                          href="../../Negocios/RegistroMedida/Eliminar.php?id_registro=<?php echo $Registros_Medida->Id_RegistroMedida[$i];?>">
                          Eliminar
                  </a>
                </td>
            </tr>
