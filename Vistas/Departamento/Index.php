 ...
 <div class="row-fluid">					
	...
	<div class="span12 well">
		<div class="page-header">
			<h4>Gestionar Departamentos</h4>
		</div>
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='gestionardepartamento.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($departamento->iddepartamento) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $departamento->iddepartamento[$i]; ?></td>
                <td> <?php echo $departamento->nombre[$i]; ?></td>
                <td><a href='gestionardepartamento.php?iddepartamento=<?php echo $departamento->iddepartamento[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Departamento/eliminar.php?id=<?php echo $departamento->iddepartamento[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
