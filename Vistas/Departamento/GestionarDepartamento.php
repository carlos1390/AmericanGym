    ...
    extract($_GET);
     ...
     ?>
     <form action='../../Negocios/Departamento/insertar.php' method="POST" >
    ...
    else
  {
    ...
    echo  "<br>";
  	...
  	$departamentotemp= new DepartamentoDAO(); 
  	//echo $idpersona;
  	$departamentotemp->obteberdepartamento($iddepartamento);
  	for ($i = 0; $i < count($departamentotemp->iddepartamento); $i++)
     {
        $nombretemp=$departamentotemp->nombre[$i];
        
     }

  	?>
  	<form action="../../Negocios/Departamento/actualizar.php" method="post">
