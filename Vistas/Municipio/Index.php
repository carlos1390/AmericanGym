	...
	<div class="span12 well">
	    ...
	    <form action="" class="form-inline">	
			<div class="input-append">
		    	 <a href='GestionarMunicipio.php' class="btn">Crear Nuevo</a>
			</div>				
	    </form>
    </div>
    <!--Tabla-->
		...
		<table class="tablesorter table table-bordered table-striped table-hover table-condensed ">
	        ...
	        for ($i=0; $i <count($Municipio->idmunicipio) ; $i++) { 
      	    ?>
      	    <tr>
               <td> <?php echo $Municipio->nombremunicipio[$i]; ?></td>
                <td> <?php echo $Municipio->nombredepartamento[$i]; ?></td>
                <td><a href='GestionarMunicipio.php?idmunicipio=<?php echo $Municipio->idmunicipio[$i];?>'>Editar</a></td>
                <td>
                  <a onclick="return confirm('Realmente desea eliminar este registro?');" 
                	href="../../Negocios/Municipio/Eliminar.php?idmunicipio=<?php echo $Municipio->idmunicipio[$i];?>">
                	Eliminar
                  </a>
                </td>
            </tr>
